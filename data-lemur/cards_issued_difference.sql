...
credit cards were issued each month.
...
This one was fairly straightforward thankfully, just needed to understand how MAX and MIN work with aggregate returns.
*/
